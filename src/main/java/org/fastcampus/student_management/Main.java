...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CourseService courseService = new CourseService(courseRepository, courseJdbcCommandRepository, studentRepository);
    ...
    //기본 데이터 추가
    StudentInfoDto studentInfoDto = new StudentInfoDto("홍길동", 20, "서울시");
    StudentInfoDto studentInfoDto1 = new StudentInfoDto("존도", 22, "경기도");
